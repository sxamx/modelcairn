...
func printUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "  modelcairn config plan [--data-dir path | --server origin] [--session-file path] [--allow-delete] [--out file] <file>")
	fmt.Fprintln(w, "  modelcairn config apply [--data-dir path | --server origin] [--session-file path] [--allow-delete] [--plan file] <file>")
	fmt.Fprintln(w, "  modelcairn config export [--data-dir path | --server origin] [--session-file path]")
	fmt.Fprintln(w, "  modelcairn secret set [--data-dir path | --server origin] [--session-file path] [--version n] <name>")
	fmt.Fprintln(w, "  modelcairn secret metadata [--data-dir path | --server origin] [--session-file path] [name]")
	fmt.Fprintln(w, "  modelcairn secret rotate [--data-dir path]")
	fmt.Fprintln(w, "  modelcairn secret delete --version n [--data-dir path | --server origin] [--session-file path] <name>")
