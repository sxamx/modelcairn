...
function Console({ session, online, onLogout }: { session: SessionContext; online: boolean; onLogout: () => void }) {
  ...
  return <div className="app-shell">
    ...
    <aside aria-label="Navegación principal"><nav><a className="active" href="#overview">Resumen</a><button onClick={() => setOnboarding(true)}>Crear primera ruta</button><a href="#resources">Recursos</a><a href="#activity">Actividad</a><a href="#settings">Configuración</a></nav><a className="repo-link" href="https://github.com/sxamx/modelcairn" rel="noreferrer">ModelCairn · Código abierto</a></aside>
    <main className="content" id="overview"><p className="eyebrow">RESUMEN</p><h1>Hola, {session.admin.username}</h1><p className="lede">Una vista privada del estado y la actividad de esta instalación.</p>{unavailable && <div className="form-error" role="status">El resumen no está disponible. Tus rutas siguen funcionando de forma independiente.</div>}
