...
const pages: { id: ConsolePage; label: string; icon: string }[] = [
  ...
  { id: "secrets", label: "Claves guardadas", icon: "key" },
...
function pageFromHash(): ConsolePage {
  const name = window.location.hash.slice(2).split("/")[0];
