# Documentación de ModelCairn

[English](README.md)

## Fuente de verdad vigente

1. [Estado y ciclo](estado-y-ciclo-del-proyecto.es.md)
2. [Project Charter](project-charter.es.md)
3. [Glosario y modelo de dominio](glosario-y-modelo-de-dominio.es.md)
4. [Requisitos base](requisitos-base.es.md)
5. [Arquitectura objetivo](arquitectura-objetivo.es.md)
...
- [Evidencia de candidata CI verificada del Hito 8](evidencia/hito-08-candidata-ci.es.md)
- [QA agrupado del Hito 8](evidencia/qa-agrupado-hito-08.es.md)
...
- [Acceso local, privado y mediante Tailscale](operacion/acceso-red-v1.es.md)
...
- [ADR-0002: licencia y atribución](decisiones/0002-licencia-y-atribucion.es.md)
- [ADR-0003: base técnica y despliegue](decisiones/0003-base-tecnica-y-despliegue.es.md)
- [ADR-0004: configuración, secretos y recuperación](decisiones/0004-configuracion-secretos-y-recuperacion.es.md)
- [ADR-0005: criptografía y backup](decisiones/0005-criptografia-y-formato-de-backup.es.md)
- [ADR-0006: consola web](decisiones/0006-stack-de-consola-web.es.md)

## Idiomas y estado

La versión inglesa es canónica y la versión española es una traducción oficial.
Ambas deben actualizarse juntas cuando cambie el significado de un documento. Un
documento viejo del prototipo no prevalece sobre este índice.
...
- [Preparación del repositorio limpio](publicacion/preparacion-del-repositorio-limpio.es.md)
