...
en los archivos del módulo. El spike del Hito 1 compila y prueba el driver y registra
un tamaño y RSS pico conservadores del artefacto de prueba, mientras que el
ejecutable no lo enlazará hasta que la persistencia forme parte del arranque. El
coste enlazado al producto volverá a medirse en ese hito.
